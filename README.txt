...
Each use can carry up to 1 item which will give them an added bonus. Users can only loot once.
...
2. Set the winning and losing currency to be given out when someone wins or dies. Default is 100 for losing and 500 for winning.
